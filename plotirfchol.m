function plotirfchol(point,upper,lower,shock,varnames,shockname, prc)
...
for i=1:N
    ...
    fill([0:horizon-1 fliplr(0:horizon-1)]' ,[squeeze(upper(i,shock, :)); flipud(squeeze(lower(i,shock, :)))],...
    [0 0.4470 0.7410],'EdgeColor','None'); hold on;
    plot(0:horizon-1,squeeze(point(i,shock, :)),'-','LineWidth',1.5,'Color','k'); hold on;
